...
#hasil
print("Nama saya adalah", dict["a"])
print("Nim saya adalah", dict["b"])
print("Saya tinggal di", dict["c"])
print("Kota Pati adalah kota yang", dict["d"])
print("Harapan saya sebagai lulusan Teknik Industri adalah", dict["e"])